...
public final class ProfilerModule extends AbstractModule {
  @Provides
  ProfilingState provideProfilingState() {
      return new ProfilingState();
  }
    @Provides
    Profiler provideProfiler(Clock clock, ProfilingState profilingState) {
        return new ProfilerImpl(clock, profilingState);
    }
}
